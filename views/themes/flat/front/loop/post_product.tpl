...
{/if}
<article class="flat-related-card article everpsblog" id="everpsblog-{$post_id|escape:'htmlall':'UTF-8'}">
    <a href="{$post_link|escape:'htmlall':'UTF-8'}" title="{$post_title|escape:'htmlall':'UTF-8'}" class="flat-related-card__image">
