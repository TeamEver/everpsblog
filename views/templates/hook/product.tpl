    ...
    {foreach from=$everpsblog item=item}
        <div class="col-12 col-xs-12 col-md-3 article everpsblog mb-3" id="everpsblog-{$item->id_ever_post|escape:'htmlall':'UTF-8'}">
                <div class="col-12 col-xs-12 article-img">
                    <img src="{$item->featured_image|escape:'htmlall':'UTF-8'}" class="img img-fluid {if $animated}animated flipSideBySide zoomed{/if}" title="{$item->title nofilter}" alt="{$item->title nofilter}"/>
                </div>
                <div class="col-12 col-xs-12">
